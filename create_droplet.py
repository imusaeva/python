...
droplet_info = '{"name": "abduls-Droplet", "region": "nyc3", "size": "s-1vcpu-1gb", "image": "ubuntu-20-04-x64"}'
...
# create_droplets(do_token=zsh_env_token)
...
def delete_droplet(do_token):
    ...
    two_headers = {"Content-Type": "application/json","Authorization": "Bearer " + do_token}
    responce = requests.delete(url, headers=two_headers)
